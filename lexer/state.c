...
/**
 * quote_state - function that updates the state of the elements between
 * the current element and the next quote element to be in the IN_QUOTE state
...
/**
 * set_state - function that updates the state of the elements
 * of the token list to be in the IN_QUOTE or IN_DQUOTE state
